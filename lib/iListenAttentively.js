...
module.exports = Object.assign(
    {
        ...
        hook(address, callback, resultType, paramsTypes, ...optionalArgs) {
            ...
            const getOptionalArg = (index, fallback) => optionalArgs[index] === undefined
                ? fallback
                : optionalArgs[index];
            const priority = getOptionalArg(0, module.exports.HookPriority.Normal);
            const suspendThreads = getOptionalArg(1, true);
            ...
            ll.exports((originalAddress, params, hookId) => callback(
                (...originalParams) => {
                    ...
                    return module.exports.dynamicCall(originalAddress, resultType, paramsTypes, originalParams);
                },
                ...params
