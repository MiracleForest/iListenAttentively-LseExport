...
if (!ll.listPlugins().find(p => p === "iListenAttentively-LseExport")) {
    logger.error("iListenAttentively-LseExport is not loaded!");
    throw new Error("iListenAttentively-LseExport is not loaded!");
}
